...
void Display::_open() {
   ...
   // _shutdownButton = new Button( 310 - 61 - 10, 10, "/home/pi/projects/elmyra/build/shutdown.png", _display->format );
...
bool Display::_initUIElements() {
	...
	if ( !_addUIElement( UIElementName::ButtonOneCup, "/home/pi/projects/elmyra/build/button_one_cup.png", bottomButtonX, bottomButtonV ) ) {
		return false;
	}

	if ( !_addUIElement( UIElementName::ButtonOkay, "/home/pi/projects/elmyra/build/button_okay.png", bottomButtonX, bottomButtonV ) ) {
		return false;
	}

	if ( !_addUIElement( UIElementName::ButtonPlus, "/home/pi/projects/elmyra/build/button_plus.png", bottomButtonX, bottomButtonV ) ) {
		return false;
	}
	...
	if ( !_addUIElement( UIElementName::ButtonTwoCups, "/home/pi/projects/elmyra/build/button_two_cups.png", bottomButtonX, bottomButtonV ) ) {
		return false;
	}

	if ( !_addUIElement( UIElementName::ButtonMinus, "/home/pi/projects/elmyra/build/button_minus.png", bottomButtonX, bottomButtonV ) ) {
		return false;
	}
	...
	if ( !_addUIElement( UIElementName::ButtonSteamActive, "/home/pi/projects/elmyra/build/button_boiler_active.png", bottomButtonX, bottomButtonV ) ) {
		return false;
	}

	if ( !_addUIElement( UIElementName::ButtonSteamInactive, "/home/pi/projects/elmyra/build/button_boiler_inactive.png", bottomButtonX, bottomButtonV ) ) {
		return false;
	}
	...
	if ( !_addUIElement( UIElementName::ButtonBack, "/home/pi/projects/elmyra/build/button_back.png", bottomButtonX, bottomButtonV ) ) {
		return false;
	}

	if ( !_addUIElement( UIElementName::ButtonShutdown, "/home/pi/projects/elmyra/build/button_shutdown.png", bottomButtonX, bottomButtonV ) ) {
		return false;
	}

	if ( !_addUIElement( UIElementName::ButtonCancel, "/home/pi/projects/elmyra/build/button_cancel.png", bottomButtonX, bottomButtonV ) ) {
		return false;
	}
